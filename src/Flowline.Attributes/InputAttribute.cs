...
{
    /// <summary>Declares an input parameter of a Dataverse Custom API for Flowline registration.</summary>
    /// <remarks>
    /// <para>
    ...
    /// </para>
    /// <para>
    /// <b>EntityReference parameters:</b> always set <see cref="Table"/> to the logical name of
