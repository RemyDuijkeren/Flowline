...
- `Flowline.wiki/11-Migration-from-spkl.md`, `12-Migration-from-Daxif.md`, `13-Migration-from-PACX.md`, `14-Migration-from-ALM-Accelerator.md` — the four guides `flowline-migration` operationalizes.
- `Flowline.wiki/09-AI-Agents.md` — confirms the current AGENTS.md / exit-code contract the core skill documents; confirms no CI/CD guide exists yet (gates `flowline-ci`).
...
**Patterns to follow:** `AI-Strategy.md` §5's existing skill sketch (content basis); `Flowline.wiki/09-AI-Agents.md` exit-code table (pull verbatim rather than re-deriving); `docs/solutions/architecture-patterns/ai-agent-consumable-cli-contract-2026-06-07.md` for the exit-code/AGENTS.md contract rationale.
